...
handler.all = async function(m, {conn}) {
  ...
  if (!chat.isBanned && m.text.match(/(anadie|a nadie|ana10|anadiez)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(pipoka|oje'u|ojo'u|ja'u la pipoka)/gi)) { 
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(alarma|sirena|al arma)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(me pego|eso no se hace|hay que denuciar|eso esta mal|)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(yo también hice asi|yo me fui|yo tome|a mi también|igualito me salio|menchi|contale)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
    const vn = './media/menchi.mp3';
    mconn.conn.sendPresenceUpdate('recording', m.chat);
    mconn.conn.sendMessage(m.chat, {audio: {url: vn}, fileName: 'error.mp3', mimetype: 'audio/mpeg', ptt: true}, {quoted: m});
  }

  if (!chat.isBanned && m.text.match(/(triste|sad|tristeza|añembyasy|que triste|que mal)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/que pasa|haihue|ndetavy)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(que comiste?|que comiste|estas muy agraciado|gracioso|payaso)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(putos|cagada)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(roñupata|ejuese|moopio|tavycho)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
  ...
  if (!chat.isBanned && m.text.match(/(agraciado|jsjsjs|jsksjsj|kkkkk|jkjkj|xd|XD)/gi)) {
    if (!db.data.chats[m.chat].audios) return;
    if (!db.data.settings[this.user.jid].audios_bot && !m.isGroup) return;
    const vn = './media/agraciado.mp3';
    mconn.conn.sendPresenceUpdate('recording', m.chat);
    mconn.conn.sendMessage(m.chat, {audio: {url: vn}, fileName: 'error.mp3', mimetype: 'audio/mpeg', ptt: true}, {quoted: m});
  }
